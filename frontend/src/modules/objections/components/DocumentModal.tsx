...
export function DocumentContent({
  ...
  if (kind === "request" && request)
    return (
      <article
        className="print-document request-template"
        style={{
      ...
      >
        ...
        <div
          className="request-template-signature"
          style={{
        ...
        >
          ...
          <b style={{ justifySelf: "end", whiteSpace: "nowrap" }}>
            Ш. Күреңбек тегі
          </b>
        </div>
        <p
          className="request-template-executor"
  ...
  if (kind === "request" && request)
    return (
      ...
      >
        ...
        <p
          className="request-template-regulatory-notice"
