...
export function wordDocumentHtml({
  ...
  const certificateLayoutCss =
    ".certificate-template{font-family:'Times New Roman',Times,serif;font-size:12pt;line-height:1;text-align:justify}.certificate-template p,.certificate-template li{line-height:1;text-align:justify}.certificate-template h1,.certificate-template h2{font-size:12pt;line-height:1;text-align:center}.certificate-template-explanation{text-align:center!important}.certificate-template-point h3{font-size:12pt;line-height:1;text-align:center}.certificate-template th,.certificate-template td,.certificate-template .certificate-point-votes-table th,.certificate-template .certificate-point-votes-table td{font-size:12pt;line-height:1}.certificate-template .certificate-point-votes-table th{text-align:center}.certificate-template .certificate-point-votes-table td{text-align:justify}";
  const css =
